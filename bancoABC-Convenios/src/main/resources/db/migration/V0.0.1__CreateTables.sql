...
insert into CONVENIO_SERVICIO(id, idConvenio, tipoOperacion, httpMethod, httpHeader, url ) values (1, 1, 'Consulta', 'GET', '', 'http://localhost:8060/agua-service/api/v.1/pagosAgua');
insert into CONVENIO_SERVICIO(id, idConvenio, tipoOperacion, httpMethod, httpHeader, url ) values (2, 1, 'Pago', 'POST', '{\"Content-type\":\"application/json\"}', 'http://localhost:8060/agua-service/api/v.1/pagosAgua');
insert into CONVENIO_SERVICIO(id, idConvenio, tipoOperacion, httpMethod, httpHeader, url ) values (3, 1, 'Compensacion', 'DELETE', '', 'http://localhost:8060/agua-service/api/v.1/pagosAgua');
